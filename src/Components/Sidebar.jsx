    ...
    <div className='w-[25%] h-full p-2 flex-col gap-2 text-white hidden lg:flex'>
      ...
      <div className="bg-[#121212] h-[85%] rounded">
        <div className="p-4 flex item-center justify-between">
            ...
            <div className="flex item-center gap-3">
                <img className='w-5 h-[70%]' src={assets.arrow_icon} alt="" />
                <img className='w-5 h-[70%]' src={assets.plus_icon} alt="" />    
            </div>
        </div>
        ...
        <div className="p-4 bg-[#242424] m-2 rounded font-semibold flex flex-col item-start justify-start gap-1 mt-4 pl-4">
